...
function BorderRadius(){
    return (
        ...
        text-blue-500 mt-2 px-4 py-2 rounded-lg"> Klik Saya </button>
    )
}

function BackgroundColors(){
    return(
        <div className="bg-cyan-400 text-fuchsia-600 mt-2 p-6 rounded-lg shadow-lg ">
...
function FlexboxGrid(){
    return (
        <nav className="flex justify-between bg-gray-800 p-4 mt-2 text-white">
...
function ShadowEffects(){
    return (
        <div className="bg-amber-400 shadow-orange-600 mt-2 p-6 rounded-lg hover:shadow-2xl transition">
